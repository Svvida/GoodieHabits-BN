...
namespace MyLambdaApi.Controllers
{
    ...
    public class WeeklyQuestController : ControllerBase
    {
        ...
        public async Task<ActionResult<WeeklyQuestDetailsDto>> GetUserQuestById(int id, CancellationToken cancellationToken = default)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<WeeklyQuestDetailsDto>>> GetAllUserQuests(CancellationToken cancellationToken = default)
        {
