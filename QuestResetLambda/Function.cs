...
public class Function
{
    ...
    public async Task FunctionHandler(ILambdaContext context)
    {
        ...
        try
        {
            var resetQuestsService = scope.ServiceProvider.GetRequiredService<IQuestResetService>();

            _logger.LogInformation("Attempting to reset quests...");

            int affectedRows = await resetQuestsService.ResetCompletedQuestsAsync(CancellationToken.None);
