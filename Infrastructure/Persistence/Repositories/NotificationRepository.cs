...
namespace Infrastructure.Persistence.Repositories
{
    ...
    {
        public async Task<Notification?> GetUserNotificationByIdAsync(int notificationId, int userProfileId, bool asNoTracking = false, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<bool> IsUserNotificationExistsAsync(int notificationId, int userProfileId, CancellationToken cancellationToken = default)
        {
            return await _context.Notifications
                .AsNoTracking()
        ...
        public async Task MarkUserNotificationAsReadAsync(int notificationId, int userProfileId, CancellationToken cancellationToken = default)
        {
