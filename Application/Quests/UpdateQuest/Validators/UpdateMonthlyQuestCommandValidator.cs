...
{
    public class UpdateMonthlyQuestCommandValidator : UpdateQuestCommandValidator<UpdateMonthlyQuestCommand>
    {
        public UpdateMonthlyQuestCommandValidator(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
