...
{
    public class CompleteDailyThirtyBadgeStrategy : IBadgeAwardingStrategy
    {
        ...
        {
            var badgeType = BadgeTypeEnum.CompleteDailySeven;
            ...
            if (quest.Statistics is not null && quest.Statistics.LongestStreak >= 30)
            {
