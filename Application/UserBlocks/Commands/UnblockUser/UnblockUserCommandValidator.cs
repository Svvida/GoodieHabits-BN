...
namespace Application.UserBlocks.Commands.UnblockUser
{
    ...
    {
        public UnblockUserCommandValidator(IUnitOfWork unitOfWork)
        {
            ...
            RuleFor(x => x.BlockedUserProfileId)
                ...
                .NotEqual(x => x.BlockerUserProfileId).WithMessage("You cannot unblock yourself.")
                ...
                }).WithMessage("The user is not blocked.");
        }
    }
}
