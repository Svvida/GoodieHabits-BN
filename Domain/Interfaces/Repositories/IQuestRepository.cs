...
namespace Domain.Interfaces.Repositories
{
    ...
    {
        Task<IEnumerable<Quest>> GetActiveQuestsForDisplayAsync(int userProfileId, DateOnly today, WeekdayEnum userLocalWeekday, int userLocalDayOfMonth, SeasonEnum currentSeason, CancellationToken cancellationToken = default);
        ...
        Task<IEnumerable<Quest>> GetRepeatableQuestsForStatsProcessingAsync(DateOnly utcToday, CancellationToken cancellationToken = default);
        Task<IEnumerable<Quest>> GetRepeatableQuestsForOccurrencesProcessingAsync(DateOnly utcToday, CancellationToken cancellationToken = default);
